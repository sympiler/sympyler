...
BOOST_PYTHON_MODULE (pynasoq) {
  ...
  class_<QPFormatConverterWrapper>("QPFormatConverter")
      .def("load_smp", &QPFormatConverterWrapper::load_smp)
      .def("smp_to_ie", &QPFormatConverterWrapper::smp_to_ie)
      .def("get_H_copy", &QPFormatConverterWrapper::get_H_copy)
      .def("get_A_copy", &QPFormatConverterWrapper::get_A_copy)
      .def("get_C_copy", &QPFormatConverterWrapper::get_C_copy)
      .def("get_q_copy", &QPFormatConverterWrapper::get_q_copy)
      .def("get_b_copy", &QPFormatConverterWrapper::get_b_copy)
      .def("get_d_copy", &QPFormatConverterWrapper::get_d_copy);
  ...
  class_<NasoqWrapper>("Nasoq", init<QPFormatConverterWrapper *>(args("QP")))
      ...
      .def("get_log", &NasoqWrapper::get_log)
          /* Attributes  */
